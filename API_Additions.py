...
class DA:
    ...
    def api_4(self, city_name):
        humidity = pd.read_csv('humidity.csv', index_col='datetime')
        humidity = humidity[city_name]

        pressure = pd.read_csv('pressure.csv', index_col='datetime')
        pressure = pressure[city_name]

        temperature = pd.read_csv('temperature.csv', index_col='datetime')
        temperature = temperature[city_name]

        wind_direction = pd.read_csv('wind_direction.csv', index_col='datetime')
        wind_direction = wind_direction[city_name]

        wind_speed = pd.read_csv('wind_speed.csv', index_col='datetime')
